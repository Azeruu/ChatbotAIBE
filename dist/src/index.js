    ...
    return streamText(c, async (stream) => {
        ...
        const titleCompletion = await groq.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "Kamu pembuat judul singkat. Buat judul 3-8 kata dalam bahasa Indonesia yang merangkum topik utama percakapan. Jangan pakai tanda kutip, nomor, atau prefix apa pun.",
                },
                {
                    role: "user",
